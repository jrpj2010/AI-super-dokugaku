            ...
            <div class="persona-basic">
                <div class="persona-card">
                    <div class="persona-photo">
                        <i class="material-symbols-outlined" style="font-size: 4rem; color:
#9ca3af;">account_circle</i>
                    </div>
...
- overflow設定: 印刷時はoverflow: visibleに変更（コンテンツが隠れないように）
- position設定: slide-contentをabsoluteからrelativeに変更
- display設定: slide-containerとslide-contentを印刷時はblockに変更
...
- pattern-b-slideクラスの追加: パターンB専用の印刷時調整を適用
...
| {{CLUSTER_N_COLOR_1}} | グラデーション開始色 | "
#FF6B6B", "
#4ECDC4" |
| {{CLUSTER_N_COLOR_2}} | グラデーション終了色 | "
#C44569", "
#44A08D" |
...
### ステップ2: 表紙作成
cover.htmlテンプレートを基に、全ての変数を実際の値に置換

### ステップ3: アジェンダページ作成
insidecover.htmlテンプレートを基に、全ての変数を実際の値に置換
...
### ステップ5: サンクスページ作成
thankyopage.htmlテンプレートを基に、全ての変数を実際の値に置換
