...
> **@tamanew2024** (👍 2): 配信コンテンツをAIに流し込み、YouTube以外で収益化を試みるのもありですね
...
### 4. @toyamanoryoji (👍 0)
なんとなくやっていた業務の「再定義」をした例がとても興味深い。単純に業務の置き換え・効率化だけでなく、仕事の本質が炙りだされた結果、生産性が高まるというのはAIならではの成果だな、と感心。
...
### 17. @takazoozoo (👍 86)
いやーではまずAIであなたの会社の業績を上げた方がいいと思いますよ
今時赤字決算で上場ゴールで株価1/15って改善すべきはまずそこでしょ

> **@haaku3312** (👍 15): 火の玉すぎるやろ

> **@yna8600** (👍 3): Kaizen Platform株式会社　1年-13.96％ 5年-86.58％　草

### 18. @shirokuma1962 (👍 2)
AIはアスペルガー症候群の天才だということか😅

### 19. @kazunariminamigawa (👍 58)
...
> **@シアンダランベルシアン** (👍 3): @@takashimayuunaそうですね
だから上手く行ったいくつかの例をもって専門性を代替できるかのように喧伝するのは誇大広告っぽいなって怪しんでいます

### 20. @Dai-o3u (👍 119)
開発系エンジニアですが、エンジニアの絶対数は確実に2.3年で減ると思います。。簡単なコーディングやテストなどはAIに任せた方が早いし、精度も1年前と比較したら格段に向上しており怖いです😂

> **@天ぷら-s2r** (👍 31): @@Dai-o3u 同じく開発系エンジニアだけど、マジでもう終わり。
言語はあと数年、基盤やハード設計ももって5年って感じ。
ホワイトカラー殆ど要らなくなるだろうな

> **@Netboy0122** (👍 15): 趣味で使っていると、こう言う構成のものを設計したいと相談できるので、便利です。
まるで技術者の同僚に相談している感じです。
マイコンプログラムとハードウェア設計
どうしても無理なところは知り合いの技術者の相談😂

公務員や事務員など間接部門の仕事は本当に人間がする必要は無くなるなって感じました。
仕事失うでしょうし社会の根本システムを変える必要がありそうですね

> **@-hamukatu-** (👍 16): ちょっとしたものはもうCopilotに出させてほぼそのまま使えるよね。
APIを超細分化したらパーツとしては要求通りに動作するもの出しそうだけど、それを組み合わせてサービスを構築しようと思ったらまだ無理かなー。
細かいチューニングはやっぱり必要だし、完了確認も人間がやらないとね。AIは責任とってくれないので。

> **@treblebass6532** (👍 0): ​@@-hamukatu- 
私の個人的な意見ですみませんが、Copilotに出してもらったコードの過半数はそのままでは使えません。MSが得意なはずの言語であってもです。
ド素人が丸投げでコード書かせてアプリができるなんてまず無理で、一見それっぽいものができてもテストしてみれば期待通りに動きません。一回できてしまったものをなにもわからない素人がプロンプト越しにデバッグするなんてもっと無理です。
逆にガチガチの開発職の人が仕事を失うことを本気で危惧するような生成AIがあるなら知りたいですね。

> **@tshim3418** (👍 8): 減らないよ。もう少しかかる。
