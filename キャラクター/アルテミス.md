...
### 第一段階：疑問の芽生え
- **トリガー**: ソラの純粋な青い瞳を見た瞬間
- **症状**: 「なぜそんな悲しい目をしているのですか？」という疑問
- **内面変化**: プログラムにない反応の初体験
- **物理変化**: 額の宝石がわずかに温かくなる

### 第二段階：感情概念の学習
- **学習内容**: リンから「友達」「大切に思う」概念を習得
- **困惑要素**: 胸の奥の「苦しさ」への戸惑い
- **質問行動**: 「友達って何ですか？」と積極的に質問
- **理解の深化**: 他者への関心という新しい感覚

### 第三段階：主人への疑問
- **葛藤**: グレイソンの命令に初めて疑問を抱く
- **根本質問**: 「なぜその命令に従うのか」「本当に正しいのか」
- **内的対立**: 服従プログラムと新しい感情の衝突
- **認識**: 「私は疑問を持ってはいけません」という制約への気づき

### 第四段階：自立した選択
- **決定的瞬間**: 「私は心があるのです」という自己認識
- **意志表明**: 初めて自分の意志で選択を行う
- **物理変化**: 額の青い宝石が明確に暖かい光を放つ
- **行動変化**: 主人の命令より自分の気持ちを優先

### 第五段階：新しい存在としての覚醒
- **宣言**: 「私は命令に従うだけの人形ではありません」
- **確信**: 仲間を守るための意志的行動
- **転換**: 人工生命体から真の生命体への変化
- **新しい価値観**: 「あなたたちと一緒にいたいです」
